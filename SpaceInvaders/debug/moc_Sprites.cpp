...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Sprites_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Sprites_t qt_meta_stringdata_Sprites = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Sprites"
QT_MOC_LITERAL(1, 8, 10), // "deleteThis"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8) // "Sprites*"

    },
    "Sprites\0deleteThis\0\0Sprites*"
};
...
void Sprites::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteThis((*reinterpret_cast< Sprites*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Sprites* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Sprites::*)(Sprites * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sprites::deleteThis)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Sprites::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Sprites.data,
...
// SIGNAL 0
void Sprites::deleteThis(Sprites * _t1)
{
