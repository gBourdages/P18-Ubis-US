...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Ship_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Ship_t qt_meta_stringdata_Ship = {
    {
QT_MOC_LITERAL(0, 0, 4), // "Ship"
QT_MOC_LITERAL(1, 5, 8), // "canShoot"
...
QT_INIT_METAOBJECT const QMetaObject Ship::staticMetaObject = { {
    &Sprites::staticMetaObject,
    qt_meta_stringdata_Ship.data,
    qt_meta_data_Ship,
    qt_static_metacall,
    nullptr,
    nullptr
